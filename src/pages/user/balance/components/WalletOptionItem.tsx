...
import { translate, format,renderField  } from '@/utils';
...
const MAX_AMOUNT_WALLET = "30.000.000";
                ...
                <div className={styles.component} >
...

                    {
                        walletInfo?.isLinked ? <Space direction="vertical">
                            ...
                            <Space><span>{translate("current_balance")} : </span><span>{ renderField(walletInfo?.balance || 0,"currency","đ")}</span></Space>
